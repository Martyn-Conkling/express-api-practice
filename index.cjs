...
// Note this JS code is for Node.js for a simple API built with Express.js and running on Node.js
...
//process is a Node.js keyword that is global variable
...
// Make sure you don't get cors errors
...
app.use(async (req, res, next) => {
  try {
    ...
    //Creating the .db property on req
...
//These app methods are writing code logic for the different HTTP requests coming in to the API
